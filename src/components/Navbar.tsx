...
const Navbar = () => {
  ...
  return <header className={cn("fixed top-0 left-0 right-0 w-full z-[9999]", isScrolled ? "bg-white shadow-md" : "bg-transparent")} style={{
    ...
    transform: 'translateZ(0)'
      ...
      transform: 'translateZ(0)'
        ...
        transform: 'translateZ(0)'
            ...
            <div className="scale-110 text-white" style={{
          ...
          <div className="mt-8 flex justify-center" style={{
        pointerEvents: 'auto'
      }}>
            <ScrollDownIndicator />
          </div>

  ...
  return (
    ...
    >
      ...
      {!isScrolled ? (
        ...
        >
          <div 
            className="bg-brand-primary py-6 rounded-full shadow-lg logo-glow logo-float px-[30px]"
            style={{
          ...
          >
            <div 
              className="scale-110 text-white"
              style={{
          ...
          {/* Add scroll down indicator below the logo - positioned lower */}
          <div className="absolute mt-60 flex justify-center" style={{ pointerEvents: 'auto' }}>
            <ScrollDownIndicator />
          </div>
        </div>
      ) : (

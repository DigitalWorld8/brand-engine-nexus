...
const PageLayout: React.FC<PageLayoutProps> = ({
  ...
  useEffect(() => {
    const timer = setTimeout(() => {
      setIsReady(true);
    }, 30); // Reduced from 50ms to 30ms for faster initialization
  ...
  return (
    <div className={`page-wrapper ${isScrolled ? 'bg-transparent' : 'bg-brand-primary'} ${isReady ? 'ready' : 'pre-animation'}`}>
      ...
      <div className={`content-container ${isScrolled ? 'w-full rounded-none' : ''} z-10 relative`}>
        <div 
          style={{
            opacity: opacityFactor,
            marginTop: isScrolled ? '64px' : '100px', 
            transition: 'opacity 0.35s cubic-bezier(0.33, 1, 0.68, 1), margin-top 0.25s cubic-bezier(0.33, 1, 0.68, 1)' // Reduced from 0.5s and 0.3s
          }} 
        ...
        >
          <div 
            ...
            style={{
              ...
              transition: 'transform 0.35s cubic-bezier(0.33, 1, 0.68, 1), margin-top 0.35s cubic-bezier(0.33, 1, 0.68, 1)' // Reduced from 0.5s
            }}
          >
            ...
            {isInitialView && (
              <div 
                ...
                style={{
                  ...
                  transition: 'backdrop-filter 0.35s cubic-bezier(0.33, 1, 0.68, 1), background-color 0.35s cubic-bezier(0.33, 1, 0.68, 1)', // Reduced from 0.5s

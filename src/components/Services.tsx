...
const Services = () => {
  ...
  return <section id="services" className="section bg-brand-light-gray py-24 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10 px-4 md:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {serviceCategories.map((category, index) => <div key={index} className="animate-fade-in-up cursor-pointer" style={{
        ...
        <Sheet open={isSheetOpen} onOpenChange={setIsSheetOpen}>
          <SheetContent className="w-full sm:max-w-lg overflow-y-auto rounded-none mx-0 my-[64px]">
            {activeService && <>
                ...
                <div className="space-y-6">
                  {activeService.services.map((service, idx) => <div key={idx} className="py-4 border-b border-gray-100 last:border-0 hover:bg-brand-light-gray/50 p-4 rounded-lg transition-all">
                      <HoverCard>

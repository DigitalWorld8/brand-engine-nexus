  ...
  return (
    <NavigationMenuItem>
      ...
      <NavigationMenuContent className={cn(
        ...
        <div className="relative w-screen max-w-6xl p-6 grid grid-cols-3 gap-8 text-left rounded-xl shadow-xl overflow-hidden">
          {/* Glowing border effect */}
          <div className="absolute inset-0 p-[2px] rounded-xl overflow-hidden pointer-events-none">
            <div className="absolute inset-0 bg-gradient-to-r from-brand-accent-blue via-brand-accent-violet to-brand-accent-yellow animate-gradient-glow rounded-xl"></div>
            <div className="absolute inset-[2px] bg-brand-light-blue rounded-xl"></div>
          </div>

          <div className="relative z-10 bg-brand-light-blue w-full h-full col-span-3 grid grid-cols-3 gap-8 p-4 rounded-xl">
